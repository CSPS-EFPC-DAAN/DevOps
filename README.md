...
|5| CI/CD & Tools     | 1. Take the following Course: [Introduction to GitHub](https://lab.github.com/githubtraining/introduction-to-github) <br/> 2. Let us know your GitHub username in the DevOps Slack Channel   | [CI/CD Tools presentations](https://github.com/CalvinRodo/cicdepresentations) 
...
|5| CI/CD & Tools     | - Complétez cette formation en ligne: [Introduction to GitHub](https://lab.github.com/githubtraining/introduction-to-github) <br/> - Soumettez-nous votre nom d'utilisateur GitHub dans la chaîne DevOps de Slack |[Présentations CI/CD Tools- anglais seulement](https://github.com/CalvinRodo/cicdepresentations) 
